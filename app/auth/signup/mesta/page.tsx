...
export default function MestaSignupPage() {
      ...
      const { error } = await supabase.auth.signUp({
        ...
        options: {
          ...
          data: {
            ...
            contract_area_id: selectedContract?.id, // Added contract_area_id for map visualization
    ...
    <div className="min-h-screen bg-mesta-navy flex flex-col items-center justify-center p-6">
      ...
      <Card className="w-full max-w-md bg-mesta-navy-light border-border">
        <CardHeader className="text-center">
          <CardTitle className="text-2xl text-white">Opprett Mesta-konto</CardTitle>
          <CardDescription className="text-muted-foreground">Registrer deg som Mesta-ansatt</CardDescription>
        </CardHeader>
        <CardContent>
          <form onSubmit={handleSignUp} className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <Input
                id="email"
                type="email"
                placeholder="ola.nordmann@mesta.no"
                required
                value={email}
          ...
          <div className="mt-6 text-center text-sm text-muted-foreground">
            Er du underentreprenør?{" "}
            <Link href="/auth/signup/ue" className="text-mesta-orange hover:underline">
              Registrer deg her
            </Link>
          </div>
